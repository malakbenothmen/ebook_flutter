...
class TColor {
  static Color get primary => const Color(0xFF233973);
  static Color get primaryLight => const Color(0xFFEDEDFC);
  static Color get text => const Color(0xff212121);
  static Color get subTitle => const Color(0xff212121).withOpacity(0.4);

  static Color get color1 => const Color(0xFFFFB1B1);
  static Color get color2 => const Color(0xffC65135);

  static Color get dColor => const Color(0xFFEDEDFC);
